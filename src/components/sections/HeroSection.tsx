  ...
  return (
    <div>
      <div className="flex items-center text-white justify-center relative max-w-6xl mx-auto">
        <Gradient className="absolute  mx-auto inset-0 z-0 rounded-4xl ring-1 ring-black/5 ring-inset mt-8" />

        <div className="mt-12 max-w-2xl md:max-w-6xl relative z-10">
          <div className="p-6 md:p-8">
            <span
              className="text-3xl md:text-6xl justify-center lg:text-8xl font-bold flex items-center text-white"
